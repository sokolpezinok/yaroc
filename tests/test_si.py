...
class TestSportident(unittest.TestCase):
    def test_new(self):
        ...
        punch = SiPunch.new(1715004, 47, t, 2, "abcdef123456")
        self.assertEqual(
            bytes(punch.raw),
    ...
    def test_decode(self):
        ...
        punch = SiPunch.from_raw(bsf8_msg, "abcdef123456")
        ...
        punch = SiPunch.from_raw(SIAC_msg, "abcdef123456")
...
class TestUsbDetection(unittest.TestCase):
    def test_com_extraction(self):
        com_port = UdevSiFactory.extract_com("SportIdent UART to USB (COM12)")
