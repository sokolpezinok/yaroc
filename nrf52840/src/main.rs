...
use yaroc_nrf52840::{
    ...
    device::Device,
    send_punch::{
        Bg77SendPunchFn, FLASH_MUTEX, SEND_PUNCH_MUTEX, backoff_retries_loop, log_at_response_task,
...
async fn main(spawner: Spawner) {
    ...
    let send_punch = SendPunch::new(bg77, &FLASH_MUTEX, spawner, mqtt_config, modem_config);
    {
